...
plt.plot(sim['Points_Magnitude'], sim['rhoN_Ar'], label = 'simulated (DSMC)')
plt.legend()
...
plt.plot(sim['Points_Magnitude'], sim['Ttra_Ar'], label = 'simulated (DSMC)')
plt.legend()
