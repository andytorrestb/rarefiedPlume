...
def plumeSourceFlowModel():
    ...
    physical_props['Po'] = 475 # 5psi in Pa

    # inflow object contains flow field properties according to plume source flow mode. 
    inflow = processSourceFlowModel(mesh_data, physical_props)
    print(inflow[0]) # numericalDensity
    # print(inflow[1])
    # print(inflow[2])
